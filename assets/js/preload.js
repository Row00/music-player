const preLoad=document.querySelector('.pre-loader');const content=document.querySelector('.content');const footer=document.querySelector('footer');preLoad.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" height="128px" width="128px" viewBox="0 0 128 128" class="pl">
<defs>
...
</svg>`;window.addEventListener('DOMContentLoaded',()=>{preLoad.style.display='none';content.style.display='flex';footer.style.display='block'})